...
<xsl:template match="baseO/OUser">
 ...
 <div class="Section1">
    ...
    <p class="Cur14" align="center"><b>Список врачей</b></p>
    <br/>
    <table class="Cur10" border="1" sellspacing="0" width="100%" bordercolor="#000000" 
      ...
      <tr>
        ...
        <td width="20%" align="center"><b>Фамилия Имя Отчество врача</b></td>
        ...
        <xsl:if test='$FlagSpec = 1'><td width="10%" align="center"><b>Специальность</b></td></xsl:if>
      ...
      <xsl:for-each select="ONext">	
         <tr>
          ...
          <xsl:if test='$FlagSpec = 1'><td align="left"><xsl:value-of select="Spec"/></td></xsl:if>          
