...
<Worksheet ss:Name="Контроль качества - медиана по пациентам" >
<x:WorksheetOptions>
<x:PageSetup>
...
-->
  <Row>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Код лаборатории в проекте</Data>
		  </Cell>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Дата измерений</Data>
		  </Cell>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Прибор</Data>
		  </Cell>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Проба</Data>
		  </Cell>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Аналит в ЛИС</Data>
		  </Cell>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Ед. измерения</Data>
		  </Cell>
		  <Cell ss:StyleID="DefaultCenter" >
			  <Data ss:Type="String" > Медиана</Data>
		  </Cell>
