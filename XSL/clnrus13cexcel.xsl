...
<Worksheet ss:Name="Количество обработанных ко" >
<x:WorksheetOptions>
<x:PageSetup>
...
<Table x:FullColumns="1" x:FullRows="1">
  ...
  <Row ss:StyleID="DefaultTitle" >
    <Cell ss:MergeAcross="3" >
      <Data ss:Type="String" >Количество обработанных контейнеров</Data>
    </Cell>
  </Row>
  <Row ss:StyleID="DefaultTitle" >
    <Cell ss:MergeAcross="3" >
  ...
  <Row ss:StyleID="DefaultTitle" >
    <Cell ss:MergeAcross="5" >
      <Data ss:Type="String" >Плательщик: <xsl:value-of select="Payment" />
      </Data>
    </Cell>
  </Row>
<xsl:choose >
...
<xsl:template name="tabhead2" >
  ...
  <Cell ss:StyleID="DefaultTableLineBackgroundBold" >
      <Data ss:Type="String" > ВСЕГО обработано контейнеров</Data>
    </Cell>
