...
<Worksheet ss:Name="Список местоположений пац" >
<x:WorksheetOptions>
<x:PageSetup>
...
<xsl:if test='$FlagLang = 1' >
  ...
  <Row ss:StyleID="DefaultTitle" >
    <Cell ss:MergeAcross="7" >
      <Data ss:Type="String" >Список местоположений пациентов для типа: <xsl:value-of select="TypeLocation" />
      </Data>
    </Cell>
  </Row>
  ...
  <Cell ss:StyleID="DefaultHeaderTable" >
      <Data ss:Type="String" > Наименование местоположения</Data>
    </Cell>
  <Cell ss:StyleID="DefaultHeaderTable" >
  ...
  <Cell ss:StyleID="DefaultHeaderTable" >
      <Data ss:Type="String" > Курьер</Data>
         ...
         <xsl:if test='$FlagType = 1' >
  <Cell ss:StyleID="DefaultHeaderTable" >
      <Data ss:Type="String" > Тип местоположения</Data>
    </Cell>
         </xsl:if >
         <xsl:if test='$FlagClient = 1' >
  <Cell ss:StyleID="DefaultHeaderTable" >
  ...
  <Cell ss:StyleID="DefaultLeft" >
      <Data ss:Type="String" > <xsl:value-of select="Courier" />
           ...
           <xsl:if test='$FlagType = 1' >
  <Cell ss:StyleID="DefaultLeft" >
      <Data ss:Type="String" > <xsl:value-of select="Type" />
      </Data>
    </Cell>
           </xsl:if >
           <xsl:if test='$FlagClient = 1' >
