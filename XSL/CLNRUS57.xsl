...
<xsl:template match="baseO/OUser">
 <html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w="urn:schemas-microsoft-com:office:word">
  ...
  <title>Отчет о количестве тестов, сделанных на анализаторе</title>
 ...
 <div class="Section1">
  ...
  <br/>
    <table class="Cur12" border="1" sellspacing="0" width="60%" bordercolor="#000000" 
         ...
         <tr style='background:#D9D9D9'>
          ...
          <td>
           ...
           <thead> <!-- повторять заголовок таблицы на каждой странице  -->
              <td width="5%" align="center" VALIGN="TOP"><b>Тест</b></td>
	     <td width="50%" align="center" VALIGN="TOP"><b>Наименование теста</b></td>
	      <td width="10%" align="center" VALIGN="TOP"><b>Количество тестов, сделанных на анализаторе</b></td>
	      <td width="10%" align="center" VALIGN="TOP"><b>Количество тестов c результатами</b></td>
           </thead>      
            ...
            <xsl:for-each select="OGrTest">
	          ...
	          <td align="right" VALIGN="TOP"><xsl:value-of select="CountTestAnalyzer"/></td>
	          <td align="right" VALIGN="TOP"><xsl:value-of select="CountTestAll"/></td>
	      </tr>
            </xsl:for-each>
            <tr style='background:#D9D9D9'>
                  <td align="left" VALIGN="TOP" colspan="2"><b>Всего <xsl:value-of select="Analyzer"/></b></td>
	          <td align="right" VALIGN="TOP"><b><xsl:value-of select="CountTestAnalyzer"/></b></td>
                  <td align="right" VALIGN="TOP"><b><xsl:value-of select="CountTestAll"/></b></td>
	    </tr>
     ...
     <!--
      <tr>
              <td align="left" VALIGN="TOP"><b>Итого <xsl:value-of select="TotalCountTestAnalyzer"/> тестов сделано на указанных анализаторах из <xsl:value-of select="TotalCountTestAll"/> тестов.</b></td>
      </tr>
     -->
   </table>
