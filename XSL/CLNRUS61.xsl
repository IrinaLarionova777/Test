...
<xsl:template match="baseO/OUser">
 ...
 <div class="Section1">
    <table class="Cur12" border="1" sellspacing="0" width="60%" bordercolor="#000000" 
           ...
           <tr>
              <td width="10%" align="center" VALIGN="TOP"><b>Код лаборатории в проекте</b></td>
	      <td width="10%" align="center" VALIGN="TOP"><b>Дата измерений</b></td>
	      <td width="20%" align="center" VALIGN="TOP"><b>Прибор</b></td>
              <td width="5%" align="center" VALIGN="TOP"><b>Проба</b></td>
              <td width="20%" align="center" VALIGN="TOP"><b>Аналит в ЛИС</b></td>
              <td width="20%" align="center" VALIGN="TOP"><b>Ед. измерения</b></td>
	      <td width="15%" align="center" VALIGN="TOP"><b>Медиана</b></td>
           </tr>      
