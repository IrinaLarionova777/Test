...
<xsl:output method="xml" encoding="Windows-1251" omit-xml-declaration="no"/>
 ...
 <html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w="urn:schemas-microsoft-com:office:word">
  ...
  <title>Отчет по мониторингу лицензий</title>
  <style type="text/css">
 ...
 <div class="Section1">
    <p class="Cur14" align="left">
	  <b>
		 Отчет по мониторингу лицензий с <xsl:value-of select="$DateStart"/>
	  </b>
    </p>
    <br/>
    <table class="Cur12" border="1" sellspacing="0" bordercolor="#000000" 
         ...
         <thead> <!-- повторять заголовок таблицы на каждой странице  -->
            ...
            <!-- <td width="20%" align="center" VALIGN="TOP"><b>Количество занятых лицензий Cache</b></td> -->
             <td width="20%" align="center" VALIGN="TOP"><b>Количество пользователей</b></td>
             <td width="20%" align="center" VALIGN="TOP"><b>Количество приборов</b></td>
            </tr>
         </thead>
	   ...
	   <!--       <td align="right" VALIGN="TOP"><xsl:value-of select="CacheLicense"/></td>                   -->
                  <td align="right" VALIGN="TOP"><xsl:value-of select="Users"/></td>
	          <td align="right" VALIGN="TOP"><xsl:value-of select="Devices"/></td>
	         </tr>
               </xsl:if>
               <xsl:if test='$Odd = "0"'>
                <tr>
    ...
    <p class="Cur14" align="left">
	  <b>
		 Максимальные значения за все время мониторинга
	  </b>
    </p>
    <br/>
    <table class="Cur12" border="1" sellspacing="0" bordercolor="#000000" 
