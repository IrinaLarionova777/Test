...
//	 for test
	public static void main(String[] args) {
		...
		try
			...
			String fileName="c:\\JasperTest2\\rpt23.jasper";
			...
			params.put("pKolItog","11.00");
				
			params.put("prefTmp","^test(\"javaTestRpt23\")");
			...
			String targetFileName = "c:\\temp\\rpt23.xlsx";
		    ReportTest1.executeAndSave(result, "xlsx", targetFileName);
